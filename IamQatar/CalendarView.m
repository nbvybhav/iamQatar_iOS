...
static const CGFloat kCalendarViewDayCellHeight      = 28;
...
static const CGFloat kCalendarViewDayFontSize        = 14;
...
- (void) initProperties{
    ...
    self.fontHeaderColor = [UIColor whiteColor];
    self.fontSelectedColor = [UIColor redColor];
    self.selectionColor = [UIColor whiteColor];
    self.todayColor = [UIColor greenColor];
    //self.bgColor = [UIColor colorWithRed:255.0/255.0f green:102.0/255.0f blue:158.0/255.0f alpha:1.0f];;
